...
function networkStop(){
  docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_CA -f $COMPOSE_FILE_COUCH stop 
}

# Start network
function networkStart(){
  docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_CA -f $COMPOSE_FILE_COUCH start
}
